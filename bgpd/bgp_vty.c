...
DEFUN (show_ip_bgp_instance_summary,
       ...
       "show ip bgp view WORD summary {json}",
       SHOW_STR
       IP_STR
       BGP_STR
       "BGP view\n"
...
DEFUN (show_bgp_instance_summary,
       ...
       "show bgp view WORD summary {json}",
       SHOW_STR
       BGP_STR
       "BGP view\n"
       "View name\n"
...
ALIAS (show_bgp_instance_summary,
       ...
       "show bgp view WORD ipv6 summary {json}",
       SHOW_STR
       BGP_STR
       "BGP view\n"
       "View name\n"
...
DEFUN (show_bgp_instance_ipv6_safi_summary,
       ...
       "show bgp view WORD ipv6 (unicast|multicast) summary {json}",
       SHOW_STR
       BGP_STR
       "BGP view\n"
       "View name\n"
...
bgp_show_peer (struct vty *vty, struct peer *p)
{
  ...
  if (! p->last_reset)
    ...
    {
      vty_out (vty, "  Last reset %s, ", peer_uptime (p->resettime, timebuf, BGP_UPTIME_LEN));
