...
/**
 * bgp_multiaccess_check() - Check that the NH & peer are connected
 * ARGUMENTS:
 *   afi - 'Nuff said
 *   ri - Ptr to bgp_info containing nexthop
 *   peer - Ptr to peer
 */
extern int bgp_multiaccess_check (afi_t a, struct bgp_info *ri, struct peer *peer);
